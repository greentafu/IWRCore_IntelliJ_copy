...
public class GumsuRepositoryImpl implements GumsuRepositoryCustom{
    private final JPAQueryFactory queryFactory;

    @Autowired
    GumsuRepositoryImpl(EntityManager entityManager){
        this.queryFactory=new JPAQueryFactory(entityManager);
    }

    @Override
    @Transactional
    public Page<Object[]> findGumsuByCustomQuery(PageRequestDTO requestDTO){
