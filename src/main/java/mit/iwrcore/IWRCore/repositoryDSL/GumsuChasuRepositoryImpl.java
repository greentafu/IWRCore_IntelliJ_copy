...
public class GumsuChasuRepositoryImpl implements GumsuChasuRepositoryCustom{
    private final JPAQueryFactory queryFactory;

    @Autowired
    GumsuChasuRepositoryImpl(EntityManager entityManager){
        this.queryFactory=new JPAQueryFactory(entityManager);
    }

    @Override
    @Transactional
    public Page<Object[]> findGumsuChasuByCustomQuery(PageRequestDTO requestDTO){
        ...
        QGumsuChasu qGumsuChasu=QGumsuChasu.gumsuChasu;
        ...
        List<Tuple> tupleList = queryFactory
                .select(qGumsuChasu, qContract, qShipment.shipNum.sum())
                .from(qGumsuChasu)
                .leftJoin(qGumsuChasu.gumsu, qGumsu)
                .leftJoin(qGumsu.balju, qBalju)
                .leftJoin(qBalju.shipments, qShipment)
                ...
                .where(builder)
                .groupBy(qGumsuChasu.gcnum)
                .offset(pageable.getOffset())
                .limit(pageable.getPageSize())
                .orderBy(qGumsuChasu.gcnum.desc())
                .fetch();
